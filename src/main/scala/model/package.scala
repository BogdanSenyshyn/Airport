...
package object model {
  ...
  def converter(string: String):String = {
    string.substring(0, 4) + "-" + string.substring(4, 6) + "-" + string.substring(6, string.length)
  }
